# Change made for Meblog

# - Change lifetime to 1 day
# - Don't use datastore
...
class SessionMiddleware(object):
    ...
    """
    def __init__(self, app, cookie_key, lifetime=DEFAULT_LIFETIME, no_datastore=True, cookie_only_threshold=DEFAULT_COOKIE_ONLY_THRESH):
        self.app = app
        self.lifetime = lifetime
        self.no_datastore = no_datastore
        self.cookie_only_thresh = cookie_only_threshold
...
class DjangoSessionMiddleware(object):
    ...
    def __init__(self):
        ...
        self.wrapped_wsgi_middleware = SessionMiddleware(fake_app, cookie_key='sgrftgh524d56e8w5q4asu241fg865rt')
